"""
@desciption: predict on test set based on protein / protein structural data.
"""
import argparse
...
"""
# All feature
python 3_predict_protein.py \
--test_file ../protein_seq_structure/test816_protein_17aa.csv \
--importance_file ../result/reproduce_train8502_proteinfea_17aa_importance.csv \
--model_file ../result/reproduce_train8502_proteinfea_17aa.model \
--outfile ../result/reproduce_test816_17aa_predicted.csv \
--outfile_metrics ../result/reproduce_test816_17aa_predicted_metrics.csv \
--ablation_name protein

# Structural feature
python 3_predict_protein.py \
--test_file ../protein_structure/test816_17aa_proteinfea.csv \
--importance_file ../result_structure/reproduce_train8502_17aa_selected_importance.csv \
--model_file ../result_structure/reproduce_train8502_17aa_selected.model \
--outfile ../result_structure/reproduce_test816_17aa_predicted.csv \
--outfile_metrics ../result_structure/reproduce_test816_17aa_predicted_metrics.csv \
--ablation_name protein_structural
"""