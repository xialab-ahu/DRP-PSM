"""
@description: 该脚本用DART选择后的特征和最佳模型参数进行五折
"""
import numpy as np
import pandas as pd
import yaml
...
"""
# Run through example
python 4-foldValidation.py \
--train_file ../allfea/train8502_RNAfea_21bp.csv \
--importance_file  ../result/reproduce_train8502_RNAfea_21bp_importance.csv \
--png_file ../5foldValidation/reproduce_train8502_RNAfea_21bp_5fold.png \
--sequence_len 21bp \
--prefix ../5foldValidation/train8502_RNAfea_21bp_DART_selected_features_importance_
"""
